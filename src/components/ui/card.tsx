  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        article: "shadow-sm hover:shadow-xl group cursor-pointer overflow-hidden",
      },
    },
    defaultVariants: {
      variant: "default",
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-lg font-bold leading-tight tracking-tight sm:text-xl", className)} {...props} />
  )
);
